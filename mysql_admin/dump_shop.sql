...
-- Database: `0_0_SHOP`
--
CREATE DATABASE IF NOT EXISTS `1_1_SHOP` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `1_1_SHOP`;
...
CREATE TABLE IF NOT EXISTS `material` (
  ...
  `material_number` float DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `material_gen_qr` (
  ...
  `stock_id` int(6) UNSIGNED DEFAULT NULL,
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `product_type_id` int(6) UNSIGNED DEFAULT NULL,
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `product_item` (
  `id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT,
  `product_reduct_id` int(6) UNSIGNED NOT NULL,
  `material_id` int(6) UNSIGNED NOT NULL,
  `product_id` int(6) UNSIGNED NOT NULL,
  `product_reduct_list` int(6) UNSIGNED NOT NULL,
  `material_number` float DEFAULT 0,
  `material_percen` float DEFAULT 100,
  `reduct_method_id` int(6) UNSIGNED NOT NULL DEFAULT 0,
  `reduct_price` float DEFAULT 0,
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `reduct_method `;
CREATE TABLE IF NOT EXISTS `reduct_method ` (
  `id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT,
  `reduct_method_name` text DEFAULT NULL,  
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `product_reduct_list`;
CREATE TABLE IF NOT EXISTS `product_reduct_list` (
  `id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT,
  `reduct_list_name` text DEFAULT NULL,
  `reduct_method_id` int(6) UNSIGNED NOT NULL DEFAULT 0,
  `preduct_group` int(6) UNSIGNED NOT NULL,
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `product_reduct_group`;
CREATE TABLE IF NOT EXISTS `product_reduct_group` (
  `id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT,
  `reduct_group_name` text DEFAULT NULL,  
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `product_sales_item` (
  ...
  `material_number` float DEFAULT 0,
  `material_price` float DEFAULT 0,
  `material_unit` text DEFAULT NULL,
  `material_group` text DEFAULT NULL,
  `item_sum_total` float DEFAULT 0,
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `product_sales_choice`;
CREATE TABLE IF NOT EXISTS `product_sales_choice` (
  `id` int(6) UNSIGNED NOT NULL AUTO_INCREMENT,
  `product_sales_id` int(6) UNSIGNED DEFAULT NULL,
  `product_reduct_list_id` int(6) UNSIGNED DEFAULT NULL,
  `product_reduct_list_name` text DEFAULT NULL,  
  `active` BOOLEAN NOT NULL DEFAULT 1,
  `reg_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
